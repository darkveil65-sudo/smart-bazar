...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast('Account created successfully! Welcome to Allkart!', 'success');
      router.push('/home');
    } catch (error: unknown) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-emerald-50 via-white to-emerald-50">
      ...
      <div className="w-full max-w-md relative z-10 animate-slideUp">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground">Allkart</h1>
        ...
        <div className="bg-card rounded-2xl shadow-lg border border-border p-8">
          ...
          <p className="text-xs text-muted-foreground text-center mb-6">Join Allkart today</p>
